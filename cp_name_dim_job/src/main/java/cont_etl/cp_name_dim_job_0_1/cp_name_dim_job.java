...
package cont_etl.cp_name_dim_job_0_1;
...
/**
 * Job: cp_name_dim_job Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class cp_name_dim_job implements TalendJob {
...
public String getSource_name(){
	...
	private final String jobName = "cp_name_dim_job";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				cp_name_dim_job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(cp_name_dim_job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_CONT_ETL_cp_name_dim_job = new byte[0];
    static byte[] commonByteArray_CONT_ETL_cp_name_dim_job = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CONT_ETL_cp_name_dim_job) {
...
public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CONT_ETL_cp_name_dim_job.length) {
				if(length < 1024 && commonByteArray_CONT_ETL_cp_name_dim_job.length == 0) {
   					commonByteArray_CONT_ETL_cp_name_dim_job = new byte[1024];
				} else {
   					commonByteArray_CONT_ETL_cp_name_dim_job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CONT_ETL_cp_name_dim_job, 0, length);
			strReturn = new String(commonByteArray_CONT_ETL_cp_name_dim_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = context.mysql_Password; 
		    ...
		    String dbquery_tDBInput_2 = "SELECT \n  coalesce(max(`cp_dim`.`cp_key`),0) as cp_key\n \nFROM `cp_dim`";
            ...
            row3.cp_key = rs_tDBInput_2.getInt(1);
...
Var.var1 = context.max_cp_id=row3.cp_key ;// ###############################
        // ###############################
        // # Output tables
...
String tableName_tDBOutput_2 = "cp_dim";
...
int count_tDBOutput_2=0;
	    ...
	    String update_tDBOutput_2 = "UPDATE `" + "cp_dim" + "` SET `cp_name` = ?,`etl_date` = ? WHERE `cp_key` = ?";
...
+"nt_global_stage`.`sample`, \n  `cont_global_stage`.`etl_load_date`\nFROM `cont_global_stage`";
        	...
        	row4.cp_name = routines.system.JDBCUtil.getString(rs_tDBInput_3, 1, false);
		                    }
...
if(row4.cp_name == null){
	finder_tUniqRow_1.cp_name = null;
}else{
	finder_tUniqRow_1.cp_name = row4.cp_name.toLowerCase();
}	
...
if(row4.cp_name == null){
	new_tUniqRow_1.cp_name = null;
}else{
	new_tUniqRow_1.cp_name = row4.cp_name.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row5 == null){ 
	
	row5 = new row5Struct();
}row5.cp_name = row4.cp_name;					
 					    ...
 					    boolean forceLooprow6 = false;
 							...
 							row6Struct row6ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_4 = false;
                        		    		...
                        		    		row6HashKey.cp_name = row5.cp_name ;
				           		...
				           		if(tHash_Lookup_row6 != null && tHash_Lookup_row6.getCount(row6HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row6' and it contains more one result from keys :  row6.cp_name = '" + row6HashKey.cp_name + "'");
								} // G 071
...
Relational.ISNULL(row6.cp_name)

 ) {
out4_tmp.cp_key = context.max_cp_id;
out4_tmp.cp_name = row5.cp_name ;
...
} else {pstmt_tDBOutput_2.setString(1, out4.cp_name);
}
...
} else {pstmt_tDBOutput_2.setInt(3 + count_tDBOutput_2, out4.cp_key);
}
 ...
 */
	...
	final String decryptedPassword_tDBInput_4 = context.mysql_Password; 
            ...
            row6.cp_key = rs_tDBInput_4.getInt(1);
        	...
        	row6.cp_name = routines.system.JDBCUtil.getString(rs_tDBInput_4, 2, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row6";
				...
				row6_HashRow.cp_key = row6.cp_key;
				
				row6_HashRow.cp_name = row6.cp_name;
 ...
 */
    ...
    public static void main(String[] args){
        final cp_name_dim_job cp_name_dim_jobClass = new cp_name_dim_job();

        int exitCode = cp_name_dim_jobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = cp_name_dim_job.class.getClassLoader().getResourceAsStream("cont_etl/cp_name_dim_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = cp_name_dim_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : cp_name_dim_job");
        }
...
/************************************************************************************************
 *     163959 characters generated by Talend Open Studio for Data Integration 
 *     on the December 8, 2019 7:17:25 PST PM
 ************************************************************************************************/