...
package cont_etl.broker_dim_load_0_1;
...
/**
 * Job: broker_dim_load Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class broker_dim_load implements TalendJob {
...
public String getSource_name(){
	...
	private final String jobName = "broker_dim_load";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				broker_dim_load.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(broker_dim_load.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class copyOfout1Struct implements routines.system.IPersistableRow<copyOfout1Struct> {
    final static byte[] commonByteArrayLock_CONT_ETL_broker_dim_load = new byte[0];
    static byte[] commonByteArray_CONT_ETL_broker_dim_load = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CONT_ETL_broker_dim_load) {
		    ...
		    while (rs_tDBInput_4.next()) {
		        nb_line_tDBInput_4++;
							...
							if(colQtyInRs_tDBInput_4 < 1) {
								row5.execution_id = null;
							} else {
		                          
            row5.execution_id = rs_tDBInput_4.getInt(1);
...
Var.var1 = context.exec_id=row5.execution_id +1;// ###############################
        // ###############################
        // # Output tables
...
public static class copyOfout2Struct implements routines.system.IPersistableRow<copyOfout2Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CONT_ETL_broker_dim_load.length) {
				if(length < 1024 && commonByteArray_CONT_ETL_broker_dim_load.length == 0) {
   					commonByteArray_CONT_ETL_broker_dim_load = new byte[1024];
				} else {
   					commonByteArray_CONT_ETL_broker_dim_load = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CONT_ETL_broker_dim_load, 0, length);
			strReturn = new String(commonByteArray_CONT_ETL_broker_dim_load, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
int count_tDBOutput_2=0;
				...
				String insert_tDBOutput_2 = "INSERT INTO `" + "job_execution_log" + "` (`execution_id`,`process_id`,`job_name`,`project_name`,`job_run_status`,`job_start__time`,`job_end_time`,`ERROR_MESSAGE`) VALUES (?,?,?,?,?,?,?,?)";
...
} else {pstmt_tDBOutput_2.setInt(1, copyOfout2.execution_id);
}

                            if(copyOfout2.process_id == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, copyOfout2.process_id);
}

                            if(copyOfout2.job_name == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, copyOfout2.job_name);
}

                            if(copyOfout2.project_name == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, copyOfout2.project_name);
}

                            if(copyOfout2.job_run_status == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5, copyOfout2.job_run_status);
}

                            if(copyOfout2.job_start__time != null) {
date_tDBOutput_2 = copyOfout2.job_start__time.getTime();
...
date_tDBOutput_2 = copyOfout2.job_end_time.getTime();
if(date_tDBOutput_2 < year1_tDBOutput_2 || date_tDBOutput_2 >= year10000_tDBOutput_2) {
...
} else {pstmt_tDBOutput_2.setString(8, copyOfout2.ERROR_MESSAGE);
}
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.mysql_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n  coalesce(max(`broker_dim`.`broker_key`),0) as broker_id\n \nFROM `broker_dim`";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row1.broker_key = null;
							} else {
		                          
            row1.broker_key = rs_tDBInput_1.getInt(1);
...
Var.var1 = context.max_broker_id = row1.broker_key +1;// ###############################
        // ###############################
        // # Output tables
...
String tableName_tDBOutput_1 = "broker_dim";
...
int count_tDBOutput_1=0;
	    ...
	    String update_tDBOutput_1 = "UPDATE `" + "broker_dim" + "` SET `broker_name` = ?,`etl_date` = ? WHERE `broker_key` = ?";
...
row3 = null;			
if(row2.broker == null){
	finder_tUniqRow_1.broker = null;
}else{
	finder_tUniqRow_1.broker = row2.broker.toLowerCase();
}	
...
if(row2.broker == null){
	new_tUniqRow_1.broker = null;
}else{
	new_tUniqRow_1.broker = row2.broker.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row3 == null){ 
	
	row3 = new row3Struct();
}row3.broker = row2.broker;					
 					    ...
 					    boolean forceLooprow4 = false;
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		...
                        		    		row4HashKey.broker_name = row3.broker ;
				           		...
				           		if(tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row4' and it contains more one result from keys :  row4.broker_name = '" + row4HashKey.broker_name + "'");
								} // G 071
...
Relational.ISNULL(row4.broker_name)

 ) {
out2_tmp.broker_key = Numeric.sequence("s1",context.max_broker_id,1) ;
out2_tmp.broker_name = row3.broker ;
...
if(out2 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(out2.broker_name == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, out2.broker_name);
}
...
pstmt_tDBOutput_1.setNull(2, java.sql.Types.DATE);
                    ...
                    if(out2.broker_key == null) {
pstmt_tDBOutput_1.setNull(3 + count_tDBOutput_1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(3 + count_tDBOutput_1, out2.broker_key);
}
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		cont_etl.common_status_03_0_1.common_status_03 childJob_tRunJob_2 = new cont_etl.common_status_03_0_1.common_status_03();
	    // pass DataSources
		    ...
		    while (rs_tDBInput_3.next()) {
		        nb_line_tDBInput_3++;
							...
							if(colQtyInRs_tDBInput_3 < 1) {
								row4.broker_key = null;
							} else {
		                          
            row4.broker_key = rs_tDBInput_3.getInt(1);
            if(rs_tDBInput_3.wasNull()){
                    row4.broker_key = null;
            }
		                    }
							if(colQtyInRs_tDBInput_3 < 2) {
								row4.broker_name = null;
							} else {
	                         		
        	row4.broker_name = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row4";
				...
				row4_HashRow.broker_key = row4.broker_key;
				
				row4_HashRow.broker_name = row4.broker_name;
 ...
 */
    ...
    public static void main(String[] args){
        final broker_dim_load broker_dim_loadClass = new broker_dim_load();

        int exitCode = broker_dim_loadClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = broker_dim_load.class.getClassLoader().getResourceAsStream("cont_etl/broker_dim_load_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = broker_dim_load.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : broker_dim_load");
        }
...
/************************************************************************************************
 *     191184 characters generated by Talend Open Studio for Data Integration 
 *     on the December 8, 2019 7:16:53 PST PM
 ************************************************************************************************/