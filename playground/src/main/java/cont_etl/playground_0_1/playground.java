...
package cont_etl.playground_0_1;
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_CONT_ETL_playground = new byte[0];
    static byte[] commonByteArray_CONT_ETL_playground = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CONT_ETL_playground.length) {
				if(length < 1024 && commonByteArray_CONT_ETL_playground.length == 0) {
   					commonByteArray_CONT_ETL_playground = new byte[1024];
				} else {
   					commonByteArray_CONT_ETL_playground = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CONT_ETL_playground, 0, length);
			strReturn = new String(commonByteArray_CONT_ETL_playground, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CONT_ETL_playground) {
...
String tableName_tDBOutput_1 = "profit_center_dim";
...
java.sql.Connection conn_tDBOutput_1 = null;
		...
		if(dbProperties_tDBOutput_1 == null || dbProperties_tDBOutput_1.trim().length() == 0) {
			url_tDBOutput_1 = "jdbc:mysql://" + context.mysql_Server + ":" + "3306" + "/" + context.mysql_Database + "?" + "rewriteBatchedStatements=true";
		} else {
			...
			url_tDBOutput_1 = "jdbc:mysql://" + context.mysql_Server + ":" + "3306" + "/" + context.mysql_Database + "?" + properties_tDBOutput_1;
		}
...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(context.mysql_Database, null, null, new String[]{"TABLE"})) {
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equalsIgnoreCase("profit_center_dim")) {
                                ...
                                try(java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                    stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1 + "`(`profit_center_key` INT(0)  ,`profit_center_name` VARCHAR(0)  ,`etl_date` DATETIME )");
                                }

				String insert_tDBOutput_1 = "INSERT INTO `" + "profit_center_dim" + "` (`profit_center_key`,`profit_center_name`,`etl_date`) VALUES (?,?,?)";
...
// # Output table : 'out1'
out1_tmp.profit_center_key = null;
out1_tmp.profit_center_name = null;
out1_tmp.etl_date = null;
out1 = out1_tmp;
// ###############################
...
if(out1 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                            if(out1.profit_center_key == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(1, out1.profit_center_key);
}

                            if(out1.profit_center_name == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, out1.profit_center_name);
}

                            if(out1.etl_date != null) {
date_tDBOutput_1 = out1.etl_date.getTime();
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = playground.class.getClassLoader().getResourceAsStream("cont_etl/playground_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     57146 characters generated by Talend Open Studio for Data Integration 
 *     on the December 8, 2019 7:16:42 PST PM
 ************************************************************************************************/