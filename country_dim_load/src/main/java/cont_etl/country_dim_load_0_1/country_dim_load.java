...
package cont_etl.country_dim_load_0_1;
...
/**
 * Job: country_dim_load Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class country_dim_load implements TalendJob {
...
public String getMysql_Port(){
	...
	private final String jobName = "country_dim_load";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				country_dim_load.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(country_dim_load.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class out3Struct implements routines.system.IPersistableRow<out3Struct> {
    final static byte[] commonByteArrayLock_CONT_ETL_country_dim_load = new byte[0];
    static byte[] commonByteArray_CONT_ETL_country_dim_load = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CONT_ETL_country_dim_load.length) {
				if(length < 1024 && commonByteArray_CONT_ETL_country_dim_load.length == 0) {
   					commonByteArray_CONT_ETL_country_dim_load = new byte[1024];
				} else {
   					commonByteArray_CONT_ETL_country_dim_load = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CONT_ETL_country_dim_load, 0, length);
			strReturn = new String(commonByteArray_CONT_ETL_country_dim_load, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CONT_ETL_country_dim_load) {
...
String tableName_tDBOutput_1 = "country_dim";
...
int count_tDBOutput_1=0;
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "country_dim" + "` (`country_key`,`fk_region_key`,`country_name`,`etl_date`) VALUES (?,?,?,?)";
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "/home/jen/Downloads/talend stuff/source/region_country.txt";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("/home/jen/Downloads/talend stuff/source/region_country.txt", "US-ASCII",",","\n",false,1,0,
...
if(row2.region == null){
	...
	finder_tUniqRow_1.region = row2.region.toLowerCase();
}
...
if(row2.region == null){
	...
	new_tUniqRow_1.region = row2.region.toLowerCase();
}
if(row2.country == null){
	...
	row3 = new row3Struct();
}row3.region = row2.region;			row3.country = row2.country;					
 					    ...
 					    boolean forceLooprow4 = false;
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		...
                        		    		row4HashKey.region_name = row3.region ;
				           		...
				           		if(tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row4' and it contains more one result from keys :  row4.region_name = '" + row4HashKey.region_name + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		...
                        		    		row5HashKey.country_name = row3.country ;
				           		...
				           		if(tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.country_name = '" + row5HashKey.country_name + "'");
								} // G 071
...
Relational.ISNULL(row5.country_name )

 ) {
out2_tmp.region_key = row4.region_key ;
out2_tmp.country_name = row3.country ;
out2 = out2_tmp;
...
// # Output table : 'out3'
out3_tmp.country_key = context.max_country_id;
out3_tmp.fk_region_key = out2.region_key ;
out3_tmp.country_name = out2.country_name ;
out3_tmp.etl_date = TalendDate.getCurrentDate() ;
out3 = out3_tmp;
// ###############################
...
if(out3 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                            if(out3.country_key == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(1, out3.country_key);
}

                            if(out3.fk_region_key == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(2, out3.fk_region_key);
}
...
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
                            ...
                            if(out3.etl_date != null) {
date_tDBOutput_1 = out3.etl_date.getTime();
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)("/home/jen/Downloads/talend stuff/source/region_country.txt") instanceof java.io.InputStream)){
...
public static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.region_name == null) ? 0 : this.region_name.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row4Struct other = (row4Struct) obj;
						...
						} else if (!this.region_name.equals(other.region_name))
	...
	public void copyDataTo(row4Struct other) {
		...
		other.region_key = this.region_key;
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.region_key = readInteger(dis,ois);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.region_key, dos, oos);
    ...
    public int compareTo(row4Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.region_name, other.region_name);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// source node:tDBInput_2 - inputs:(after_tFileInputDelimited_1) outputs:(row4,row4) | target node:tAdvancedHash_row4 - inputs:(row4) outputs:()
			   		// linked node: tMap_2 - inputs:(row3,row4,row5) outputs:(out2)
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = context.mysql_Password; 
		    ...
		    while (rs_tDBInput_2.next()) {
		        nb_line_tDBInput_2++;
							...
							if(colQtyInRs_tDBInput_2 < 1) {
								row4.region_key = null;
							} else {
		                          
            row4.region_key = rs_tDBInput_2.getInt(1);
        	...
        	row4.region_name = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
				...
				if(rs_tDBInput_2.getString(3) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_2) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
						row4.etl_date = rs_tDBInput_2.getTimestamp(3);
					} else {
						row4.etl_date = (java.util.Date) year0_tDBInput_2.clone();
					}
				} else {
					row4.etl_date =  null;
				}
 ...
 */
	...
	currentComponent="tAdvancedHash_row4";
				...
				row4_HashRow.region_key = row4.region_key;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row5";
		...
		int tos_count_tAdvancedHash_row5 = 0;
			   		...
			   		// source node:tDBInput_3 - inputs:(after_tFileInputDelimited_1) outputs:(row5,row5) | target node:tAdvancedHash_row5 - inputs:(row5) outputs:()
			   		// linked node: tMap_2 - inputs:(row3,row4,row5) outputs:(out2)
...
+"im`.`etl_date`\nFROM `country_dim`";
		    ...
		    while (rs_tDBInput_3.next()) {
		        nb_line_tDBInput_3++;
							...
							if(colQtyInRs_tDBInput_3 < 1) {
								row5.country_key = null;
							} else {
		                          
            row5.country_key = rs_tDBInput_3.getInt(1);
            if(rs_tDBInput_3.wasNull()){
                    row5.country_key = null;
            }
		                    }
							if(colQtyInRs_tDBInput_3 < 2) {
								row5.fk_region_key = null;
							} else {
		                          
            row5.fk_region_key = rs_tDBInput_3.getInt(2);
            if(rs_tDBInput_3.wasNull()){
                    row5.fk_region_key = null;
            }
		                    }
        	...
        	row5.country_name = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
		                    }
				...
				if(rs_tDBInput_3.getString(4) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_3) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_3)) {
						row5.etl_date = rs_tDBInput_3.getTimestamp(4);
					} else {
						row5.etl_date = (java.util.Date) year0_tDBInput_3.clone();
					}
				} else {
					row5.etl_date =  null;
				}
 ...
 */
	...
	currentComponent="tAdvancedHash_row5";
				...
				row5_HashRow.country_key = row5.country_key;
				
				row5_HashRow.fk_region_key = row5.fk_region_key;
...
class tRowGenerator_1Randomizer {
	...
	for (int itRowGenerator_1=0; itRowGenerator_1<nb_max_row_tRowGenerator_1 ;itRowGenerator_1++) {
		row7.newColumn = randtRowGenerator_1.getRandomnewColumn();
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.mysql_Password; 
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n  coalesce(max(`country_dim`.`country_key`),0) as country_key\n  \nFROM `country_dim`";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row1.country_key = null;
							} else {
		                          
            row1.country_key = rs_tDBInput_1.getInt(1);
...
Var.var1 = context.max_country_id=row1.country_key+1;// ###############################
        // ###############################
        // # Output tables
 ...
 */
    ...
    public static void main(String[] args){
        final country_dim_load country_dim_loadClass = new country_dim_load();

        int exitCode = country_dim_loadClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = country_dim_load.class.getClassLoader().getResourceAsStream("cont_etl/country_dim_load_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = country_dim_load.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("exec_id")) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : country_dim_load");
        }
...
/************************************************************************************************
 *     190684 characters generated by Talend Open Studio for Data Integration 
 *     on the December 8, 2019 7:17:09 PST PM
 ************************************************************************************************/