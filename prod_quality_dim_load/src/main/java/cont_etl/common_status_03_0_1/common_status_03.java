...
package cont_etl.common_status_03_0_1;
...
/**
 * Job: common_status_03 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class common_status_03 implements TalendJob {
...
public String getSource_name(){
	...
	private final String jobName = "common_status_03";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				common_status_03.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(common_status_03.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_CONT_ETL_common_status_03 = new byte[0];
    static byte[] commonByteArray_CONT_ETL_common_status_03 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CONT_ETL_common_status_03.length) {
				if(length < 1024 && commonByteArray_CONT_ETL_common_status_03.length == 0) {
   					commonByteArray_CONT_ETL_common_status_03 = new byte[1024];
				} else {
   					commonByteArray_CONT_ETL_common_status_03 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CONT_ETL_common_status_03, 0, length);
			strReturn = new String(commonByteArray_CONT_ETL_common_status_03, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CONT_ETL_common_status_03) {
...
int count_tDBOutput_1=0;
	    ...
	    String update_tDBOutput_1 = "UPDATE `" + "job_execution_log" + "` SET `job_run_status` = ?,`job_end_time` = ? WHERE `execution_id` = ?";
...
// # Output table : 'out1'
out1_tmp.execution_id = context.exec_id;
out1_tmp.job_run_status = "success";
out1_tmp.job_end_time = TalendDate.getCurrentDate() ;
out1 = out1_tmp;
// ###############################
...
} else {pstmt_tDBOutput_1.setString(1, out1.job_run_status);
}
...
} else {pstmt_tDBOutput_1.setInt(3 + count_tDBOutput_1, out1.execution_id);
}
 ...
 */
    ...
    public static void main(String[] args){
        final common_status_03 common_status_03Class = new common_status_03();

        int exitCode = common_status_03Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = common_status_03.class.getClassLoader().getResourceAsStream("cont_etl/common_status_03_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = common_status_03.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : common_status_03");
        }
...
/************************************************************************************************
 *     59574 characters generated by Talend Open Studio for Data Integration 
