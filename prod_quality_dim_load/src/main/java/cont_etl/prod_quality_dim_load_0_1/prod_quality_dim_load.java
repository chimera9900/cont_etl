...
package cont_etl.prod_quality_dim_load_0_1;
...
/**
 * Job: prod_quality_dim_load Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20191031_1204-M3
 * @status 
 */
public class prod_quality_dim_load implements TalendJob {
...
public String getSource_name(){
	...
	private final String jobName = "prod_quality_dim_load";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				prod_quality_dim_load.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(prod_quality_dim_load.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_CONT_ETL_prod_quality_dim_load = new byte[0];
    static byte[] commonByteArray_CONT_ETL_prod_quality_dim_load = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CONT_ETL_prod_quality_dim_load) {
...
public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CONT_ETL_prod_quality_dim_load.length) {
				if(length < 1024 && commonByteArray_CONT_ETL_prod_quality_dim_load.length == 0) {
   					commonByteArray_CONT_ETL_prod_quality_dim_load = new byte[1024];
				} else {
   					commonByteArray_CONT_ETL_prod_quality_dim_load = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CONT_ETL_prod_quality_dim_load, 0, length);
			strReturn = new String(commonByteArray_CONT_ETL_prod_quality_dim_load, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = context.mysql_Password; 
		    ...
		    String dbquery_tDBInput_2 = "SELECT \n  coalesce(max(`prod_quality_dim`.`prod_quality_key`),0) as prod_quality_key\nFROM `prod_quality_dim`";
            ...
            row3.prod_quality_key = rs_tDBInput_2.getInt(1);
...
Var.var1 = context.max_prod_quality=row3.prod_quality_key +1;// ###############################
        // ###############################
        // # Output tables
...
String tableName_tDBOutput_2 = "prod_quality_dim";
...
int count_tDBOutput_2=0;
				...
				String insert_tDBOutput_2 = "INSERT INTO `" + "prod_quality_dim" + "` (`prod_quality_key`,`fk_prod_key`,`prod_quality_name`,`etl_date`) VALUES (?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tDBInput_3 = context.mysql_Password; 
		    ...
		    String dbquery_tDBInput_3 = "SELECT \n  `cont_global_prestage`.`profit_center`, \n  `cont_global_prestage`.`product_name`, \n  `cont_global_prestage`.`"
+"contract_type`, \n  `cont_global_prestage`.`issue_date`, \n  `cont_global_prestage`.`contract_status`, \n  `cont_global_pre"
+"stage`.`inventory_status`, \n  `cont_global_prestage`.`contract_ref_no`, \n  `cont_global_prestage`.`cp_ref`, \n  `cont_glo"
+"bal_prestage`.`cp_name`, \n  `cont_global_prestage`.`allocated_contract`, \n  `cont_global_prestage`.`origin`, \n  `cont_gl"
+"obal_prestage`.`quality`, \n  `cont_global_prestage`.`crop_year`, \n  `cont_global_prestage`.`quantity`, \n  `cont_global_p"
+"restage`.`quantity_unit`, \n  `cont_global_prestage`.`shipment_start_date`, \n  `cont_global_prestage`.`shipment_end_date`"
+", \n  `cont_global_prestage`.`exchange`, \n  `cont_global_prestage`.`month`, \n  `cont_global_prestage`.`price`, \n  `cont_g"
+"lobal_prestage`.`price_units`, \n  `cont_global_prestage`.`inco_terms`, \n  `cont_global_prestage`.`broker`, \n  `cont_glob"
+"al_prestage`.`boker_ref_no`, \n  `cont_global_prestage`.`commission`, \n  `cont_global_prestage`.`sample`, \n  `cont_global"
+"_prestage`.`etl_load_date`\nFROM `cont_global_prestage`";
        	...
        	row4.issue_date = routines.system.JDBCUtil.getString(rs_tDBInput_3, 4, false);
		                    }
        	...
        	row4.crop_year = routines.system.JDBCUtil.getString(rs_tDBInput_3, 13, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 14) {
								row4.quantity = null;
							} else {
	                         		
        	row4.quantity = routines.system.JDBCUtil.getString(rs_tDBInput_3, 14, false);
		                    }
        	...
        	row4.shipment_start_date = routines.system.JDBCUtil.getString(rs_tDBInput_3, 16, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 17) {
								row4.shipment_end_date = null;
							} else {
	                         		
        	row4.shipment_end_date = routines.system.JDBCUtil.getString(rs_tDBInput_3, 17, false);
		                    }
        	...
        	row4.etl_load_date = routines.system.JDBCUtil.getString(rs_tDBInput_3, 27, false);
		                    }
...
// # Output table : 'out4'
out4_tmp.product_name = row4.product_name ;
out4_tmp.quality = row4.quality ;
out4 = out4_tmp;
// ###############################
...
if(out4.product_name == null){
	...
	finder_tUniqRow_1.product_name = out4.product_name.toLowerCase();
}
if(out4.quality == null){
	finder_tUniqRow_1.quality = null;
}else{
	finder_tUniqRow_1.quality = out4.quality.toLowerCase();
}	
...
if(out4.product_name == null){
	...
	new_tUniqRow_1.product_name = out4.product_name.toLowerCase();
}
if(out4.quality == null){
	new_tUniqRow_1.quality = null;
}else{
	new_tUniqRow_1.quality = out4.quality.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row5 == null){ 
	
	row5 = new row5Struct();
}row5.product_name = out4.product_name;			row5.quality = out4.quality;					
 					    ...
 					    boolean forceLooprow6 = false;
 							...
 							row6Struct row6ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
                        		    		...
                        		    		row6HashKey.prod_quality_name = row5.quality ;
				           		...
				           		if(tHash_Lookup_row6 != null && tHash_Lookup_row6.getCount(row6HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row6' and it contains more one result from keys :  row6.prod_quality_name = '" + row6HashKey.prod_quality_name + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
                        		    		...
                        		    		row7HashKey.product_name = row5.product_name ;
				           		...
				           		if(tHash_Lookup_row7 != null && tHash_Lookup_row7.getCount(row7HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row7' and it contains more one result from keys :  row7.product_name = '" + row7HashKey.product_name + "'");
								} // G 071
...
Relational.ISNULL(row6.prod_quality_name )

 ) {
out5_tmp.prod_quality_key = context.max_prod_quality;
out5_tmp.fk_prod_key = row7.product_key ;
out5_tmp.prod_quality_name = row5.quality ;
out5_tmp.etl_date = TalendDate.getCurrentDate() ;
out5 = out5_tmp;
...
if(out5 != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                            if(out5.prod_quality_key == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(1, out5.prod_quality_key);
}

                            if(out5.fk_prod_key == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(2, out5.fk_prod_key);
}

                            if(out5.prod_quality_name == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, out5.prod_quality_name);
}

                            if(out5.etl_date != null) {
date_tDBOutput_2 = out5.etl_date.getTime();
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row6";
		...
		int tos_count_tAdvancedHash_row6 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(row5,row6,row7) outputs:(out5)
		    ...
		    while (rs_tDBInput_4.next()) {
		        nb_line_tDBInput_4++;
							...
							if(colQtyInRs_tDBInput_4 < 1) {
								row6.prod_quality_key = null;
							} else {
		                          
            row6.prod_quality_key = rs_tDBInput_4.getInt(1);
            if(rs_tDBInput_4.wasNull()){
                    row6.prod_quality_key = null;
            }
		                    }
							if(colQtyInRs_tDBInput_4 < 2) {
								row6.fk_prod_key = null;
							} else {
		                          
            row6.fk_prod_key = rs_tDBInput_4.getInt(2);
            if(rs_tDBInput_4.wasNull()){
                    row6.fk_prod_key = null;
            }
		                    }
							if(colQtyInRs_tDBInput_4 < 3) {
								row6.prod_quality_name = null;
							} else {
	                         		
        	row6.prod_quality_name = routines.system.JDBCUtil.getString(rs_tDBInput_4, 3, false);
		                    }
				...
				if(rs_tDBInput_4.getString(4) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_4) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_4)) {
						row6.etl_date = rs_tDBInput_4.getTimestamp(4);
					} else {
 ...
 */
	...
	currentComponent="tAdvancedHash_row6";
				...
				row6_HashRow.prod_quality_key = row6.prod_quality_key;
				
				row6_HashRow.fk_prod_key = row6.fk_prod_key;
				
				row6_HashRow.prod_quality_name = row6.prod_quality_name;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// source node:tDBInput_5 - inputs:(after_tDBInput_3) outputs:(row7,row7) | target node:tAdvancedHash_row7 - inputs:(row7) outputs:()
			   		// linked node: tMap_5 - inputs:(row5,row6,row7) outputs:(out5)
 ...
 */
	...
	final String decryptedPassword_tDBInput_5 = context.mysql_Password; 
		    ...
		    while (rs_tDBInput_5.next()) {
		        nb_line_tDBInput_5++;
							...
							if(colQtyInRs_tDBInput_5 < 1) {
								row7.product_key = null;
							} else {
		                          
            row7.product_key = rs_tDBInput_5.getInt(1);
        	...
        	row7.product_name = routines.system.JDBCUtil.getString(rs_tDBInput_5, 2, false);
		                    }
				...
				if(rs_tDBInput_5.getString(3) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_5) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_5)) {
						row7.etl_date = rs_tDBInput_5.getTimestamp(3);
					} else {
						row7.etl_date = (java.util.Date) year0_tDBInput_5.clone();
					}
				} else {
					row7.etl_date =  null;
				}
 ...
 */
	...
	currentComponent="tAdvancedHash_row7";
				...
				row7_HashRow.product_key = row7.product_key;
 ...
 */
    ...
    public static void main(String[] args){
        final prod_quality_dim_load prod_quality_dim_loadClass = new prod_quality_dim_load();

        int exitCode = prod_quality_dim_loadClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = prod_quality_dim_load.class.getClassLoader().getResourceAsStream("cont_etl/prod_quality_dim_load_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = prod_quality_dim_load.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : prod_quality_dim_load");
        }
...
/************************************************************************************************
 *     212430 characters generated by Talend Open Studio for Data Integration 
 *     on the December 8, 2019 7:17:44 PST PM
 ************************************************************************************************/